...
#ifndef __ATLProject5_i_h__
#define __ATLProject5_i_h__
...
#ifndef __IBStringClass_FWD_DEFINED__
#define __IBStringClass_FWD_DEFINED__
typedef interface IBStringClass IBStringClass;

#endif 	/* __IBStringClass_FWD_DEFINED__ */
...
#ifndef __BStringClass_FWD_DEFINED__
#define __BStringClass_FWD_DEFINED__

#ifdef __cplusplus
typedef class BStringClass BStringClass;
#else
typedef struct BStringClass BStringClass;
#endif /* __cplusplus */

#endif 	/* __BStringClass_FWD_DEFINED__ */
...
#ifndef __IBStringClass_INTERFACE_DEFINED__
#define __IBStringClass_INTERFACE_DEFINED__

/* interface IBStringClass */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IBStringClass;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("f6f0553a-a921-4e70-aa05-476f0cac9cbe")
    IBStringClass : public IDispatch
    {
    public:
    ...
    typedef struct IBStringClassVtbl
    {
        BEGIN_INTERFACE
        ...
        DECLSPEC_XFGVIRT(IBStringClass, get_Value)
        /* [id][propget] */ HRESULT ( STDMETHODCALLTYPE *get_Value )( 
            IBStringClass * This,
            /* [retval][out] */ BSTR *pVal);
        
        DECLSPEC_XFGVIRT(IBStringClass, put_Value)
        /* [id][propput] */ HRESULT ( STDMETHODCALLTYPE *put_Value )( 
            IBStringClass * This,
            /* [in] */ BSTR newVal);
        
        DECLSPEC_XFGVIRT(IBStringClass, Append)
    ...
    interface IBStringClass
    {
        CONST_VTBL struct IBStringClassVtbl *lpVtbl;
    };
...
#define IBStringClass_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IBStringClass_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IBStringClass_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IBStringClass_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IBStringClass_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IBStringClass_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IBStringClass_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IBStringClass_get_Value(This,pVal)	\
    ( (This)->lpVtbl -> get_Value(This,pVal) ) 

#define IBStringClass_put_Value(This,newVal)	\
    ( (This)->lpVtbl -> put_Value(This,newVal) ) 

#define IBStringClass_Append(This,str,result)	\
    ( (This)->lpVtbl -> Append(This,str,result) ) 
...
#endif 	/* __IBStringClass_INTERFACE_DEFINED__ */



#ifndef __ATLProject5Lib_LIBRARY_DEFINED__
#define __ATLProject5Lib_LIBRARY_DEFINED__

/* library ATLProject5Lib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_ATLProject5Lib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("00088510-9c7b-440d-b4f5-35bef3e1b971")
CompReg;
#endif

EXTERN_C const CLSID CLSID_BStringClass;

#ifdef __cplusplus

class DECLSPEC_UUID("8c88f7b7-be9a-42d9-b499-40d42a9bffff")
BStringClass;
#endif
#endif /* __ATLProject5Lib_LIBRARY_DEFINED__ */
